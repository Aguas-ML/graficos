![ÁguasML](img/logo_aguasml_nice.png)
...
To add a new page at the URL `http://aguas-ml.github.io/example`:
...
chronologically at `https://aguas-ml.github.io/blog/`, with all the pagination
...
The members page (`pessoas.md`), is populated by data in `_data/people.yaml`. This
data is pulled from the [member AirTable database](https://airtable.com/).
...
This project is a clone of [**R Epidemics Consortium (RECON) website**](https://www.repidemicsconsortium.org/)
